...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){let e=new Worker(this.workerSourceURL);e._callbacks={},e._taskCosts={},e._taskLoad=0,e.postMessage({type:`init`,decoderConfig:this.decoderConfig}),e.onmessage=function(t){let n=t.data;switch(n.type){case`decode`:e._callbacks[n.id].resolve(n);break;case`error`:e._callbacks[n.id].reject(n);break;default:console.error(`THREE.DRACOLoader: Unexpected message, "`+n.type+`"`)}},this.workerPool.push(e)}else this.workerPool.sort(function(e,t){return e._taskLoad>t._taskLoad?-1:1});let n=this.workerPool[this.workerPool.length-1];return n._taskCosts[e]=t,n._taskLoad+=t,n})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log(`Task load: `,this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==``&&URL.revokeObjectURL(this.workerSourceURL),this}};function Vl(){let e,t;onmessage=function(r){let i=r.data;switch(i.type){case`init`:e=i.decoderConfig,t=new Promise(function(t){e.onModuleLoaded=function(e){t({draco:e})},DracoDecoderModule(e)});break;case`decode`:let r=i.buffer,a=i.taskConfig;t.then(e=>{let t=e.draco,o=new t.Decoder;try{let e=n(t,o,new Int8Array(r),a),s=e.attributes.map(e=>e.array.buffer);e.index&&s.push(e.index.array.buffer),self.postMessage({type:`decode`,id:i.id,geometry:e},s)}catch(e){console.error(e),self.postMessage({type:`error`,id:i.id,error:e.message})}finally{t.destroy(o)}});break}};function n(e,t,n,a){let o=a.attributeIDs,s=a.attributeTypes,c,l,u=t.GetEncodedGeometryType(n);if(u===e.TRIANGULAR_MESH)c=new e.Mesh,l=t.DecodeArrayToMesh(n,n.byteLength,c);else if(u===e.POINT_CLOUD)c=new e.PointCloud,l=t.DecodeArrayToPointCloud(n,n.byteLength,c);else throw Error(`THREE.DRACOLoader: Unexpected geometry type.`);if(!l.ok()||c.ptr===0)throw Error(`THREE.DRACOLoader: Decoding failed: `+l.error_msg());let d={index:null,attributes:[]};for(let n in o){let r=self[s[n]],l,u;if(a.useUniqueIDs)u=o[n],l=t.GetAttributeByUniqueId(c,u);else{if(u=t.GetAttributeId(c,e[o[n]]),u===-1)continue;l=t.GetAttribute(c,u)}let f=i(e,t,c,n,r,l);n===`color`&&(f.vertexColorSpace=a.vertexColorSpace),d.attributes.push(f)}return u===e.TRIANGULAR_MESH&&(d.index=r(e,t,c)),e.destroy(c),d}function r(e,t,n){let r=n.num_faces()*3,i=r*4,a=e._malloc(i);t.GetTrianglesUInt32Array(n,i,a);let o=new Uint32Array(e.HEAPF32.buffer,a,r).slice();return e._free(a),{array:o,itemSize:1}}function i(e,t,n,r,i,o){let s=n.num_points(),c=o.num_components(),l=a(e,i),u=c*i.BYTES_PER_ELEMENT,d=Math.ceil(u/4)*4,f=d/i.BYTES_PER_ELEMENT,p=s*u,m=s*d,h=e._malloc(p);t.GetAttributeDataArrayForAllPoints(n,o,l,p,h);let g=new i(e.HEAPF32.buffer,h,p/i.BYTES_PER_ELEMENT),_;if(u===d)_=g.slice();else{_=new i(m/i.BYTES_PER_ELEMENT);let e=0;for(let t=0,n=g.length;t<n;t++){for(let n=0;n<c;n++)_[e+n]=g[t*c+n];e+=f}}return e._free(h),{name:r,count:s,itemSize:c,array:_,stride:f}}function a(e,t){switch(t){case Float32Array:return e.DT_FLOAT32;case Int8Array:return e.DT_INT8;case Int16Array:return e.DT_INT16;case Int32Array:return e.DT_INT32;case Uint8Array:return e.DT_UINT8;case Uint16Array:return e.DT_UINT16;case Uint32Array:return e.DT_UINT32}}}var Hl=[`Shoulder_Pitch`,`Shoulder_Roll`,`Shoulder_Yaw`,`Elbow`,`Wrist_Yaw`,`Wrist_Roll`,`Wrist_Pitch`],Ul=Hl.length,Wl=[.0372,.0066,-.055],Gl=[-.5643,.1724,-.8074],Kl=[.8196,-7e-4,-.573],ql=(e,t)=>t===`L`?e:[e[0],-e[1],e[2]];function Jl(e){return Math.hypot(...e)}function Yl(e){let t=Jl(e)||1;return e.map(e=>e/t)}function Xl(e,t){return[e[1]*t[2]-e[2]*t[1],e[2]*t[0]-e[0]*t[2],e[0]*t[1]-e[1]*t[0]]}function Zl(e,t,n){return[e[0],t[0],n[0],e[1],t[1],n[1],e[2],t[2],n[2]]}function Ql(e,t){let n=Array(9);for(let r=0;r<3;r++)for(let i=0;i<3;i++)n[r*3+i]=e[r*3]*t[i*3]+e[r*3+1]*t[i*3+1]+e[r*3+2]*t[i*3+2];return n}function $l(e,t){let n=Array(9);for(let r=0;r<3;r++)for(let i=0;i<3;i++)n[r*3+i]=e[r*3]*t[i]+e[r*3+1]*t[3+i]+e[r*3+2]*t[6+i];return n}var eu=e=>{let t=Math.cos(e),n=Math.sin(e);return[1,0,0,0,t,-n,0,n,t]},tu=e=>{let t=Math.cos(e),n=Math.sin(e);return[t,0,n,0,1,0,-n,0,t]},nu=e=>{let t=Math.cos(e),n=Math.sin(e);return[t,-n,0,n,t,0,0,0,1]};function ru(e,t){return[e[0]*t[0]+e[1]*t[1]+e[2]*t[2],e[3]*t[0]+e[4]*t[1]+e[5]*t[2],e[6]*t[0]+e[7]*t[1]+e[8]*t[2]]}function iu(e){let t=e[0]+e[4]+e[8],n=Math.min(1,Math.max(-1,(t-1)/2)),r=Math.acos(n);if(r<1e-9)return[0,0,0];let i=Math.sin(r);if(i<1e-6){let t=[e[0]+1,e[4]+1,e[8]+1],n=t.indexOf(Math.max(...t)),i=[e[n],e[3+n],e[6+n]];return i[n]+=1,Yl(i).map(e=>e*r)}return[(e[7]-e[5])/(2*i)*r,(e[2]-e[6])/(2*i)*r,(e[3]-e[1])/(2*i)*r]}function au(e){let[t,n,r]=e[0],[i,a,o]=e[1],[s,c,l]=e[2],u=t*(a*l-o*c)-n*(i*l-o*s)+r*(i*c-a*s);if(Math.abs(u)<1e-14)return null;let d=1/u;return[[(a*l-o*c)*d,(r*c-n*l)*d,(n*o-r*a)*d],[(o*s-i*l)*d,(t*l-r*s)*d,(r*i-t*o)*d],[(i*c-a*s)*d,(n*s-t*c)*d,(t*a-n*i)*d]]}function ou(e,t,n){let r=au([0,1,2].map(t=>[0,1,2].map(r=>e[t].reduce((t,n,i)=>t+n*e[r][i],0)+(t===r?n:0))));return r?Array.from({length:t},(t,n)=>[0,1,2].map(t=>e[0][n]*r[0][t]+e[1][n]*r[1][t]+e[2][n]*r[2][t])):null}function su(e,t,n){return Array.from({length:n},(n,r)=>e[r][0]*t[0]+e[r][1]*t[1]+e[r][2]*t[2])}function cu(e,t,n,r={}){let{lambda:i=.08,maxStep:a=.12,iters:o=6,oriWeight:s=.3,tilt:c=.9}=r,l=(n,r)=>e.mj_name2id(t,n.value,r),u=Hl.map(t=>l(e.mjtObj.mjOBJ_JOINT,`${n}_${t}_Joint`)),d=Hl.map(t=>l(e.mjtObj.mjOBJ_ACTUATOR,`${n}_${t}_Position`)),f=l(e.mjtObj.mjOBJ_BODY,`${n}_Palm_Link`);if(u.includes(-1)||d.includes(-1)||f<0)throw Error(`IK: could not resolve ${n} arm in the model`);let p=u.map(e=>t.jnt_qposadr[e]),m=u.map(e=>t.jnt_dofadr[e]),h=u.map(e=>t.jnt_range[e*2]),g=u.map(e=>t.jnt_range[e*2+1]),_=ql(Wl,n),v=Yl(ql(Gl,n)),y=Yl(ql(Kl,n)),b=Zl(v,y,Yl(Xl(v,y))),x=new e.MjData(t),S=new e.DoubleBuffer(3*t.nv),C=new e.DoubleBuffer(3*t.nv),w=()=>S.GetView(),T=()=>C.GetView(),E=p.map(e=>x.qpos[e]);function D(){let e=[x.xpos[f*3],x.xpos[f*3+1],x.xpos[f*3+2]],t=Array.from({length:9},(e,t)=>x.xmat[f*9+t]);return{R:t,point:e.map((e,n)=>e+ru(t,_)[n])}}let O=(()=>{let e=Yl([-Math.sin(c),0,-Math.cos(c)]),t=[1,0,0];return t=Yl(Xl(t,e)),t=Yl(Xl(e,t)),Zl(t,e,Yl(Xl(t,e)))})();function ee(n,r=[0,0,0]){let[c,l,u]=typeof r==`number`?[0,0,r]:r,d=Ql($l(nu(u),$l(tu(l),$l(eu(c),O))),b),_=0,v=0,y=null;if(!n.every(Number.isFinite))return{posErr:NaN,oriErr:NaN,stall:`target not finite`};for(let r=0;r<o;r++){for(let e=0;e<Ul;e++)x.qpos[p[e]]=E[e];e.mj_kinematics(t,x),e.mj_comPos(t,x);let{R:r,point:o}=D();if(!o.every(Number.isFinite)){y=`kinematics not finite`;break}let c=[n[0]-o[0],n[1]-o[1],n[2]-o[2]],l=iu(Ql(d,r));if(_=Jl(c),v=Jl(l),_<5e-4&&v<.005)break;e.mj_jac(t,x,S,C,o,f);let u=w(),b=T();if(!u||u.length<3*t.nv||!b||b.length<3*t.nv){y=`jacobian view detached`;break}let O=[0,1,2].map(e=>m.map(n=>u[e*t.nv+n])),ee=[0,1,2].map(e=>m.map(n=>b[e*t.nv+n]));if(!O.every(e=>e.every(Number.isFinite))){y=`jacobian not finite`;break}let k=i*i,A=ou(O,Ul,k);if(!A)break;let j=su(A,c,Ul),te=ou(ee,Ul,k);if(te){let e=su(te,l,Ul);for(let t=0;t<Ul;t++){let n=e[t];for(let r=0;r<Ul;r++){let i=A[t][0]*O[0][r]+A[t][1]*O[1][r]+A[t][2]*O[2][r];n-=i*e[r]}j[t]+=n*s}}let ne=Jl(j);if(!Number.isFinite(ne)){y=`step not finite`;break}let re=ne>a?a/ne:1;for(let e=0;e<Ul;e++){let t=Math.min(g[e],Math.max(h[e],E[e]+j[e]*re));Number.isFinite(t)&&(E[e]=t)}}return{posErr:_,oriErr:v,stall:y}}function k(e){for(let t=0;t<Ul;t++)Number.isFinite(E[t])&&(e.ctrl[d[t]]=E[t])}function A(){for(let e=0;e<Ul;e++)x.qpos[p[e]]=E[e];return e.mj_kinematics(t,x),D().point}return{solve:ee,apply:k,graspPoint:A,jointCount:Ul,side:n}}var lu={forward:[`w`,`W`],back:[`s`,`S`],left:[`a`,`A`],right:[`d`,`D`],up:[`r`,`R`],down:[`f`,`F`],rollPos:[`u`,`U`],rollNeg:[`o`,`O`],pitchPos:[`i`,`I`],pitchNeg:[`k`,`K`],yawPos:[`j`,`J`,`q`,`Q`],yawNeg:[`l`,`L`,`e`,`E`],grip:[` `],switchHand:[`Tab`],reset:[`g`,`G`],home:[`h`,`H`],view:[`v`,`V`]},uu=[[`W / S`,`forward / back`,`Moves the grasp target away from / toward the robot along its facing axis.`],[`A / D`,`left / right`,`Slides the grasp target sideways, from the robot's point of view.`],[`R / F`,`up / down`,`Raises or lowers the grasp target. Bench top sits at 0.15 m.`],[`U / O`,`roll`,`Rolls the target frame about the world X (forward) axis.`],[`I / K`,`pitch`,`Pitches the target frame about the world Y axis — tips the approach direction.`],[`J / L`,`yaw`,`Yaws the target frame about the world Z (vertical) axis, lining the fingers up with an object. Q / E do the same.`],[`Space`,`close hand (hold)`,`Ramps the grip while held. One axis drives every finger; the 4th-order polynomial coupling then drives the distal joints.`],[`Shift`,`precision`,`Quarter speed on every axis, for placing the hand rather than swinging it.`],[`Tab`,`switch hand`,`Hands over control to the other arm. The idle arm holds its last pose.`],[`V`,`first ⇄ third person`,`Toggles between the robot's own head camera and a free orbit camera.`],[`H`,`recentre target`,`Snaps the grasp target back to its starting point over the bench, and zeroes roll/pitch/yaw.`],[`G`,`reset scene`,`Returns the robot and every prop to the starting state.`],[`Esc`,`menu`,`Opens status and settings. Press again to return to the scene.`],[`drag`,`orbit camera`,`Third person only — the first-person view is fixed to the head.`],[`wheel`,`zoom`,`Third person only.`]],du={x:.45,y:.15,z:.34};function fu(e,t,n={}){let{moveRate:r=.3,rotRate:i=2,gripRate:a=3.2,precision:o=.25,bounds:s={x:[.1,.7],y:[-.45,.45],z:[.02,.95]}}=n,c={target:new K(du.x,du.y,n.height??du.z),rpy:[0,0,0],grip:0,hand:`L`,view:`fpv`,resetRequested:!1,gamepadGrip:!1},l=new Set,u=new Set([` `,`Tab`]);addEventListener(`keydown`,e=>{u.has(e.key)&&e.preventDefault(),l.has(e.key)||(lu.switchHand.includes(e.key)&&(c.hand=c.hand===`L`?`R`:`L`),lu.reset.includes(e.key)&&(c.resetRequested=!0),lu.home.includes(e.key)&&(c.target.set(du.x,du.y,du.z),c.rpy=[0,0,0]),lu.view.includes(e.key)&&(c.view=c.view===`fpv`?`orbit`:`fpv`)),l.add(e.key)}),addEventListener(`keyup`,e=>l.delete(e.key)),addEventListener(`blur`,()=>l.clear());let d=e=>e.some(e=>l.has(e)),f=(e,[t,n])=>Math.min(n,Math.max(t,e));function p(e){let t=l.has(`Shift`)?o:1,n=r*e*t;d(lu.forward)&&(c.target.x+=n),d(lu.back)&&(c.target.x-=n),d(lu.left)&&(c.target.y+=n),d(lu.right)&&(c.target.y-=n),d(lu.up)&&(c.target.z+=n),d(lu.down)&&(c.target.z-=n),c.target.x=f(c.target.x,s.x),c.target.y=f(c.target.y,s.y),c.target.z=f(c.target.z,s.z);let u=i*e*t;d(lu.rollPos)&&(c.rpy[0]+=u),d(lu.rollNeg)&&(c.rpy[0]-=u),d(lu.pitchPos)&&(c.rpy[1]+=u),d(lu.pitchNeg)&&(c.rpy[1]-=u),d(lu.yawPos)&&(c.rpy[2]+=u),d(lu.yawNeg)&&(c.rpy[2]-=u);let p=navigator.getGamepads?.().find(e=>e&&e.connected),m=p?Math.max(p.buttons[6]?.value??0,p.buttons[7]?.value??0):0;if(c.gamepadGrip=m>.02,c.gamepadGrip)c.grip=m;else{let t=+!!d(lu.grip);c.grip+=Math.sign(t-c.grip)*Math.min(Math.abs(t-c.grip),a*e)}let h=c.resetRequested;return c.resetRequested=!1,{target:[c.target.x,c.target.y,c.target.z],rpy:[c.rpy[0],c.rpy[1],c.rpy[2]],grip:c.grip,hand:c.hand,view:c.view,reset:h,fine:t!==1,gamepad:c.gamepadGrip,moving:d(lu.forward)||d(lu.back)||d(lu.left)||d(lu.right)||d(lu.up)||d(lu.down),turning:d(lu.rollPos)||d(lu.rollNeg)||d(lu.pitchPos)||d(lu.pitchNeg)||d(lu.yawPos)||d(lu.yawNeg)}}return{update:p,state:c}}var pu=new URLSearchParams(location.search).get(`mjcf`)??`mjcf/game_level0_slim.xml`,mu=[`Index`,`Middle`,`Ring`,`Little`],hu={MCP:1.35,PIP:1.55},gu={CMC:1.15,MCP:1.25,OPPOSE:1.45},_u=new Map,vu=document.getElementById(`log`),yu=document.getElementById(`stats`),bu=performance.now(),xu=[];function Su(e,t){xu.push([e,performance.now()-t])}function Cu(e){console.log(`[probe]`,e),vu.textContent=e;let t=document.getElementById(`boot`);t&&!t.hidden&&(t.textContent=e)}function wu(e,t,n=``){_u.set(e,{v:t,cls:n}),yu.innerHTML=[..._u].map(([e,t])=>`<tr><td class="k">${e}</td><td class="v ${t.cls}">${t.v}</td></tr>`).join(``)}var Tu=e=>new URL(e,document.baseURI).href;async function Eu(e,t){let n=Tu(`model/${t}`),r=await fetch(n);if(!r.ok)throw Error(`fetch ${n} -> ${r.status}`);let i=new Uint8Array(await r.arrayBuffer()),a=`/model/`+t.split(`/`).slice(0,-1).join(`/`);return e.FS.mkdirTree(a),e.FS.writeFile(`/model/${t}`,i),i.byteLength}async function Du(e,t){let n=performance.now(),r=new TextDecoder,i=0,a=new Set,o=new Set,s=[t];for(;s.length;){let t=s.pop();if(a.has(t))continue;a.add(t),i+=await Eu(e,t);let n=r.decode(e.FS.readFile(`/model/${t}`)),c=t.split(`/`).slice(0,-1).join(`/`);for(let e of n.matchAll(/<include\s+file="([^"]+)"/gi))s.push(c?`${c}/${e[1]}`:e[1]);for(let e of n.matchAll(/file="([^"]+\.stl)"/gi))o.add(e[1])}let c=[...o];wu(`xml staged`,a.size),wu(`meshes referenced`,c.length),Cu(`staging ${c.length} meshes…`);let l=0,u=await Promise.all(Array.from({length:12},async()=>{let t=0;for(;c.length;){let n=c.pop();t+=await Eu(e,`meshes/${n}`),++l%20==0&&Cu(`staging meshes… ${l}`)}return t}));i+=u.reduce((e,t)=>e+t,0);let d=performance.now()-n;return wu(`staged`,`${(i/1048576).toFixed(1)} MB`),wu(`stage time`,`${(d/1e3).toFixed(2)} s`),i}var Ou={PLANE:0,SPHERE:2,CAPSULE:3,ELLIPSOID:4,CYLINDER:5,BOX:6,MESH:7};function ku(e,t){let n=e.mesh_vertadr[t],r=e.mesh_vertnum[t],i=e.mesh_faceadr[t],a=e.mesh_facenum[t],o=new Float32Array(r*3);for(let t=0;t<r*3;t++)o[t]=e.mesh_vert[n*3+t];let s=new Uint32Array(a*3);for(let t=0;t<a*3;t++)s[t]=e.mesh_face[i*3+t];let c=new zr;return c.setAttribute(`position`,new wr(o,3)),c.setIndex(new wr(s,1)),c.computeVertexNormals(),c}function Au(e,t){switch(e){case Ou.PLANE:return new Ai(20,20);case Ou.SPHERE:return new ji(t[0],24,16);case Ou.CYLINDER:return new ki(t[0],t[0],t[1]*2,24);case Ou.CAPSULE:return new Oi(t[0],t[1]*2,8,16);case Ou.ELLIPSOID:return new ji(1,24,16).scale(t[0],t[1],t[2]);case Ou.BOX:return new Di(t[0]*2,t[1]*2,t[2]*2);default:return null}}function ju(e,t){let n=new In;n.rotation.x=-Math.PI/2;let r=0;for(let e=0;e<t.ngeom;e++)t.geom_group[e]<3&&r++;let i=r===0;wu(`render source`,i?`collision geoms`:`visual geoms`,i?`warn`:``);let a=[],o=0;for(let e=0;e<t.ngeom;e++){if(!i&&t.geom_group[e]>=3){o++;continue}let r=t.geom_type[e],s=[t.geom_size[e*3],t.geom_size[e*3+1],t.geom_size[e*3+2]],c=r===Ou.MESH?ku(t,t.geom_dataid[e]):Au(r,s);if(!c)continue;let l=t.geom_matid[e],u=l>=0?[0,1,2,3].map(e=>t.mat_rgba[l*4+e]):[0,1,2,3].map(n=>t.geom_rgba[e*4+n]),d=new di(c,new Ui({color:new X(u[0],u[1],u[2]),metalness:.08,roughness:.62,transparent:u[3]<1,opacity:u[3]}));d.userData.localPos=new K(t.geom_pos[e*3],t.geom_pos[e*3+1],t.geom_pos[e*3+2]),d.userData.localQuat=new Bt(t.geom_quat[e*4+1],t.geom_quat[e*4+2],t.geom_quat[e*4+3],t.geom_quat[e*4]),d.userData.bodyId=t.geom_bodyid[e],n.add(d),a.push(d)}return wu(`rendered geoms`,a.length),wu(`collision hidden`,o),{root:n,visuals:a}}async function Mu(e,t,n,r){let i;try{i=await fetch(Tu(`render/scene.json`)).then(e=>e.ok?e.json():Promise.reject(e.status))}catch{wu(`render assets`,`missing — run export_render_assets.py`,`bad`);return}let a=new Bl;a.setDecoderPath(Tu(`draco/`)),a.setDecoderConfig({type:`wasm`});let o=e=>new Promise((t,n)=>{a.load(Tu(`render/${e.file}`),t,void 0,n)}),s=0,c=Array(i.meshes.length),l=i.meshes.map((e,t)=>[e,t]);await Promise.all(Array.from({length:8},async()=>{for(;l.length;){let[e,t]=l.pop();try{let n=await o(e);n.computeVertexNormals(),c[t]=n}catch(t){console.error(`[probe] draco failed:`,e.file,t)}++s%15==0&&Cu(`decoding meshes… ${s}/${i.meshes.length}`)}})),a.dispose();let u=c.filter(Boolean).length;u<i.meshes.length&&wu(`draco decode`,`${u}/${i.meshes.length} ok`,`bad`);let d=new Map,f=0;for(let a of i.geoms){if(!c[a.mesh])continue;let i=e.mj_name2id(t,e.mjtObj.mjOBJ_BODY.value,a.body);if(i<0){f++;continue}let o=a.rgba.join(`,`);d.has(o)||d.set(o,new Ui({color:new X(a.rgba[0],a.rgba[1],a.rgba[2]),metalness:.1,roughness:.55,transparent:a.rgba[3]<1,opacity:a.rgba[3]}));let s=new di(c[a.mesh],d.get(o));s.userData.localPos=new K(...a.pos),s.userData.localQuat=new Bt(a.quat[1],a.quat[2],a.quat[3],a.quat[0]),s.userData.bodyId=i,n.add(s),r.push(s)}let p=i.meshes.reduce((e,t)=>e+(t.verts||0),0);wu(`render assets`,`${i.geoms.length} geoms · ${p.toLocaleString()} verts`,`good`),wu(`mesh format`,`draco q${i.quantization}`+(i.reduction?` · reduced ${i.reduction}`:` · full res`),`good`),f&&wu(`unresolved bodies`,f,`bad`)}function Nu(e,t){let n=new K,r=new Bt;for(let i of e){let e=i.userData.bodyId;n.set(t.xpos[e*3],t.xpos[e*3+1],t.xpos[e*3+2]),r.set(t.xquat[e*4+1],t.xquat[e*4+2],t.xquat[e*4+3],t.xquat[e*4]),i.position.copy(i.userData.localPos).applyQuaternion(r).add(n),i.quaternion.copy(r).multiply(i.userData.localQuat)}}function Pu(e,t){let n=new Map;for(let r=0;r<t.nu;r++){let i=e.mj_id2name(t,e.mjtObj.mjOBJ_ACTUATOR.value,r);i&&n.set(i,r)}return n}var Fu=30*Math.PI/180;function Iu(e,t){let n=t.get(`Neck_Pitch_Position`);n!==void 0&&(e.ctrl[n]=Fu)}function Lu(e,t,n,r){r.qpos<0||(n.qpos[r.qpos]=Fu,n.qvel[r.dof]=0,e.mj_forward(t,n))}function Ru(e,t){let n=e.mj_name2id(t,e.mjtObj.mjOBJ_JOINT.value,`Neck_Pitch_Joint`);return n<0?{qpos:-1,dof:-1}:{qpos:t.jnt_qposadr[n],dof:t.jnt_dofadr[n]}}function zu(e,t,n,r){let i=(n,r)=>{let i=t.get(n);i!==void 0&&(e.ctrl[i]=r)};for(let e of mu)i(`${r}_${e}_MCP_Position`,n*hu.MCP),i(`${r}_${e}_PIP_Position`,n*hu.PIP);i(`${r}_Thumb_CMC_Position`,n*gu.CMC),i(`${r}_Thumb_MCP_Position`,n*gu.MCP),i(`${r}_Thumb_Yaw_Position`,r===`L`?gu.OPPOSE:-gu.OPPOSE)}async function Bu(){Cu(`loading physics engine…`);let e=performance.now(),t=await p();Su(`wasm`,e),wu(`mujoco`,t.mj_versionString?t.mj_versionString():`loaded`,`good`),wu(`scene`,pu),e=performance.now(),await Du(t,pu),Su(`fetch model`,e),Cu(`compiling model…`);let n=performance.now(),r=t.MjModel.from_xml_path(`/model/${pu}`),i=new t.MjData(r),a=performance.now()-n;Su(`compile`,n);let o=r.opt.timestep;wu(`compile time`,`${(a/1e3).toFixed(2)} s`,a>5e3?`warn`:`good`),wu(`nq / nv / nu`,`${r.nq} / ${r.nv} / ${r.nu}`),wu(`ngeom / neq`,`${r.ngeom} / ${r.neq}`),wu(`model timestep`,`${o.toFixed(5)} s`);let s=Pu(t,r);function c(e,n,a){t.mj_resetData(r,i),zu(i,s,n,`L`),zu(i,s,n,`R`);for(let e=0;e<600;e++)t.mj_step(r,i);let c=2e3,l=performance.now();for(let e=0;e<c;e++)t.mj_step(r,i);let u=c/(performance.now()-l)*1e3,d=u*o;return wu(e,`${u.toFixed(0)} st/s · ${d.toFixed(2)}x · ncon ${i.ncon}`,a??(d>=2?`good`:d>=1?`warn`:`bad`)),d}if(new URLSearchParams(location.search).has(`bench`)){Cu(`benchmarking physics…`),e=performance.now(),c(`bench: hands open`,0);let n=c(`bench: hands closed`,1);wu(`budget @60fps`,`${(100/n).toFixed(1)}% of frame`,n>=2?`good`:`warn`),Su(`benchmark`,e),t.mj_resetData(r,i)}let l=document.getElementById(`view`),u=new fl({canvas:l,antialias:!0});u.setPixelRatio(Math.min(devicePixelRatio,2));let d=new Gn;d.background=new X(1316636),d.fog=new Wn(1316636,4,14);let f=new Ta(45,1,.02,100);f.position.set(1.5,.95,1.15);let h=new Cl(f,u.domElement);h.target.set(.35,.3,0),h.enableDamping=!0,h.mouseButtons={LEFT:m.ROTATE,MIDDLE:m.DOLLY,RIGHT:m.ROTATE},u.domElement.addEventListener(`contextmenu`,e=>e.preventDefault()),d.add(new pa(12374766,1777446,1));let g=new Oa(16777215,2);g.position.set(2.4,3.2,1.8),d.add(g);let _=new Oa(9680096,.5);_.position.set(-2,1.5,-1.6),d.add(_);let v=Ru(t,r);t.mj_resetData(r,i),Lu(t,r,i,v);let{root:y,visuals:b}=ju(t,r);e=performance.now(),await Mu(t,r,y,b),Su(`render assets`,e),wu(`rendered total`,b.length),d.add(y);let x=Pu(t,r);wu(`actuators mapped`,x.size,x.size===r.nu?`good`:`warn`);let S=Number(new URLSearchParams(location.search).get(`oriw`)),C=Number.isFinite(S)&&S>0?{oriWeight:S}:{},w={L:cu(t,r,`L`,C),R:cu(t,r,`R`,C)},T=fu(l,f,{height:.32}),E=e=>`<span class="key">${e}</span>`;document.getElementById(`keys`).innerHTML=uu.map(([e,t])=>`<tr><td>${E(e)}</td><td>${t}</td></tr>`).join(``),document.getElementById(`keydetail`).innerHTML=uu.map(([e,t,n])=>`<tr><td>${E(e)}</td><td>${t}<div class="why">${n}</div></td></tr>`).join(``);let D=document.getElementById(`menu`),O=document.getElementById(`tab-status`),ee=document.getElementById(`tab-keys`),k=document.getElementById(`pane-status`),A=document.getElementById(`pane-keys`);function j(e){let t=e===`status`;O.setAttribute(`aria-selected`,String(t)),ee.setAttribute(`aria-selected`,String(!t)),k.hidden=!t,A.hidden=t}O.addEventListener(`click`,()=>j(`status`)),ee.addEventListener(`click`,()=>j(`keys`)),addEventListener(`keydown`,e=>{e.key===`Escape`&&(e.preventDefault(),D.hidden=!D.hidden,D.hidden||dispatchEvent(new Event(`blur`)))});let te=document.getElementById(`gripfill`),ne=document.getElementById(`gripval`),re=new In,ie=new di(new Mi(.035,.0035,8,40),new $r({color:7200655,transparent:!0,opacity:.9}));ie.rotation.x=Math.PI/2;let ae=new di(new ki(.0015,.0015,1,6),new $r({color:7200655,transparent:!0,opacity:.35}));re.add(ie,ae),d.add(re);let oe=new di(new ji(.012,16,12),new $r({color:15778408}));d.add(oe);let se=([e,t,n])=>new K(e,n,-t),ce=t.mj_name2id(r,t.mjtObj.mjOBJ_BODY.value,`orbbec_link`);ce<0&&wu(`fpv`,`orbbec_link missing`,`bad`);let M=[1,0,0],le=[0,0,1],ue=e=>{let t=zt.degToRad(e);M=[Math.cos(t),0,-Math.sin(t)],le=[Math.sin(t),0,Math.cos(t)]},de=new K,fe=new K,N=new K,P=(e,t)=>[e[0]*t[0]+e[1]*t[1]+e[2]*t[2],e[3]*t[0]+e[4]*t[1]+e[5]*t[2],e[6]*t[0]+e[7]*t[1]+e[8]*t[2]];function pe(){if(ce<0)return!1;let e=[i.xpos[ce*3],i.xpos[ce*3+1],i.xpos[ce*3+2]],t=Array.from({length:9},(e,t)=>i.xmat[ce*9+t]);return de.copy(se(e)),fe.copy(se(P(t,M))).add(de),N.copy(se(P(t,le))),f.position.copy(de),f.up.copy(N),f.lookAt(fe),!0}let me=document.getElementById(`fov`),he=document.getElementById(`fovval`),ge=()=>{f.fov=Number(me.value),f.updateProjectionMatrix(),he.textContent=`${me.value}°`};me.addEventListener(`input`,ge),ge();let _e=document.getElementById(`pitch`),ve=document.getElementById(`pitchval`),ye=()=>{ue(Number(_e.value)),ve.textContent=`${_e.value}°`};_e.addEventListener(`input`,ye),ye();let be={pos:f.position.clone(),target:h.target.clone()},xe=null;window.__probe={mujoco:t,model:r,data:i,ik:w,input:T,acts:x};function Se(){let e=l.clientWidth||innerWidth,t=l.clientHeight||innerHeight;!e||!t||(u.setSize(e,t,!1),f.aspect=e/t,f.updateProjectionMatrix())}new ResizeObserver(Se).observe(l),addEventListener(`resize`,Se),Se();let Ce=0,we=performance.now(),Te=0,Ee=we,De=0,Oe=0,ke=performance.now()-bu;wu(`startup`,`${(ke/1e3).toFixed(2)} s total`,ke<5e3?`good`:ke<9e3?`warn`:`bad`);for(let[e,t]of xu)wu(`  ${e}`,`${(t/1e3).toFixed(2)} s`);console.log(`[probe] startup breakdown`,xu.map(([e,t])=>`${e} ${(t/1e3).toFixed(2)}s`).join(` · `),`| total ${(ke/1e3).toFixed(2)}s`),document.getElementById(`boot`).hidden=!0,Cu(`running.`),u.setAnimationLoop(()=>{let e=performance.now(),n=(e-we)/1e3;we=e,n>.25&&(n=.25),Oe++;let a=T.update(n);a.reset&&(t.mj_resetData(r,i),Lu(t,r,i,v)),Iu(i,x);let s=w[a.hand],c=s.solve(a.target,a.rpy);s.apply(i),w[a.hand===`L`?`R`:`L`].apply(i),zu(i,x,a.grip,a.hand),te.style.width=`${(a.grip*100).toFixed(0)}%`,ne.textContent=a.grip.toFixed(2),re.position.copy(se(a.target));let l=Math.max(.001,a.target[2]-.15);ae.scale.y=l,ae.position.y=-l/2,oe.position.copy(se(s.graspPoint())),Ce+=n;let p=0;for(;Ce>=o&&p<40;)t.mj_step(r,i),Ce-=o,p++;if(p===40&&(Ce=0),De+=p,Nu(b,i),a.view!==xe&&(a.view===`fpv`?(be.pos.copy(f.position),be.target.copy(h.target)):(f.position.copy(be.pos),f.up.set(0,1,0),h.target.copy(be.target)),h.enabled=a.view===`orbit`,xe=a.view),a.view===`fpv`?pe():h.update(),u.render(d,f),Te++,e-Ee>500){let t=(e-Ee)/1e3;if(wu(`fps`,(Te/t).toFixed(0)),wu(`substeps/frame`,(De/Te).toFixed(1)),wu(`contacts`,i.ncon),wu(`view`,a.view===`fpv`?`first person · Femto Bolt −30°`:`third person · orbit`),v.qpos>=0){let e=i.qpos[v.qpos]*57.2958;wu(`neck pitch`,`${e.toFixed(2)}° (welded 30°)`,Math.abs(e-30)<.5?`good`:`bad`)}wu(`hand`,a.hand+(a.fine?` (fine)`:``)+(a.gamepad?` · pad grip`:``)),wu(`target xyz`,a.target.map(e=>e.toFixed(2)).join(`  `)),wu(`target rpy`,a.rpy.map(e=>{let t=((e*57.2958+180)%360+360)%360-180;return(t===-180?180:t).toFixed(0).padStart(4)}).join(` `)),c.stall?wu(`IK residual`,`stalled: ${c.stall}`,`bad`):wu(`IK residual`,`${(c.posErr*1e3).toFixed(1)} mm · ${(c.oriErr*57.2958).toFixed(1)}°`,c.posErr<.01?`good`:c.posErr<.05?`warn`:`bad`),wu(`frames`,Oe),Te=0,De=0,Ee=e}})}`serviceWorker`in navigator&&addEventListener(`load`,()=>{navigator.serviceWorker.register(Tu(`sw.js`)).catch(e=>console.warn(`[probe] service worker registration failed`,e))}),Bu().catch(e=>{console.error(e),Cu(`FAILED: `+(e?.message??e)),wu(`status`,`failed`,`bad`)});export{o as t};