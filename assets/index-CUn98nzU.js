...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){let e=new Worker(this.workerSourceURL);e._callbacks={},e._taskCosts={},e._taskLoad=0,e.postMessage({type:`init`,decoderConfig:this.decoderConfig}),e.onmessage=function(t){let n=t.data;switch(n.type){case`decode`:e._callbacks[n.id].resolve(n);break;case`error`:e._callbacks[n.id].reject(n);break;default:console.error(`THREE.DRACOLoader: Unexpected message, "`+n.type+`"`)}},this.workerPool.push(e)}else this.workerPool.sort(function(e,t){return e._taskLoad>t._taskLoad?-1:1});let n=this.workerPool[this.workerPool.length-1];return n._taskCosts[e]=t,n._taskLoad+=t,n})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log(`Task load: `,this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==``&&URL.revokeObjectURL(this.workerSourceURL),this}};function Vl(){let e,t;onmessage=function(r){let i=r.data;switch(i.type){case`init`:e=i.decoderConfig,t=new Promise(function(t){e.onModuleLoaded=function(e){t({draco:e})},DracoDecoderModule(e)});break;case`decode`:let r=i.buffer,a=i.taskConfig;t.then(e=>{let t=e.draco,o=new t.Decoder;try{let e=n(t,o,new Int8Array(r),a),s=e.attributes.map(e=>e.array.buffer);e.index&&s.push(e.index.array.buffer),self.postMessage({type:`decode`,id:i.id,geometry:e},s)}catch(e){console.error(e),self.postMessage({type:`error`,id:i.id,error:e.message})}finally{t.destroy(o)}});break}};function n(e,t,n,a){let o=a.attributeIDs,s=a.attributeTypes,c,l,u=t.GetEncodedGeometryType(n);if(u===e.TRIANGULAR_MESH)c=new e.Mesh,l=t.DecodeArrayToMesh(n,n.byteLength,c);else if(u===e.POINT_CLOUD)c=new e.PointCloud,l=t.DecodeArrayToPointCloud(n,n.byteLength,c);else throw Error(`THREE.DRACOLoader: Unexpected geometry type.`);if(!l.ok()||c.ptr===0)throw Error(`THREE.DRACOLoader: Decoding failed: `+l.error_msg());let d={index:null,attributes:[]};for(let n in o){let r=self[s[n]],l,u;if(a.useUniqueIDs)u=o[n],l=t.GetAttributeByUniqueId(c,u);else{if(u=t.GetAttributeId(c,e[o[n]]),u===-1)continue;l=t.GetAttribute(c,u)}let f=i(e,t,c,n,r,l);n===`color`&&(f.vertexColorSpace=a.vertexColorSpace),d.attributes.push(f)}return u===e.TRIANGULAR_MESH&&(d.index=r(e,t,c)),e.destroy(c),d}function r(e,t,n){let r=n.num_faces()*3,i=r*4,a=e._malloc(i);t.GetTrianglesUInt32Array(n,i,a);let o=new Uint32Array(e.HEAPF32.buffer,a,r).slice();return e._free(a),{array:o,itemSize:1}}function i(e,t,n,r,i,o){let s=n.num_points(),c=o.num_components(),l=a(e,i),u=c*i.BYTES_PER_ELEMENT,d=Math.ceil(u/4)*4,f=d/i.BYTES_PER_ELEMENT,p=s*u,m=s*d,h=e._malloc(p);t.GetAttributeDataArrayForAllPoints(n,o,l,p,h);let g=new i(e.HEAPF32.buffer,h,p/i.BYTES_PER_ELEMENT),_;if(u===d)_=g.slice();else{_=new i(m/i.BYTES_PER_ELEMENT);let e=0;for(let t=0,n=g.length;t<n;t++){for(let n=0;n<c;n++)_[e+n]=g[t*c+n];e+=f}}return e._free(h),{name:r,count:s,itemSize:c,array:_,stride:f}}function a(e,t){switch(t){case Float32Array:return e.DT_FLOAT32;case Int8Array:return e.DT_INT8;case Int16Array:return e.DT_INT16;case Int32Array:return e.DT_INT32;case Uint8Array:return e.DT_UINT8;case Uint16Array:return e.DT_UINT16;case Uint32Array:return e.DT_UINT32}}}var Hl=[`Shoulder_Pitch`,`Shoulder_Roll`,`Shoulder_Yaw`,`Elbow`,`Wrist_Yaw`,`Wrist_Roll`,`Wrist_Pitch`],Ul=Hl.length,Wl=[.0372,.0066,-.055],Gl=[-.5643,.1724,-.8074],Kl=[.8196,-7e-4,-.573],ql=(e,t)=>t===`L`?e:[e[0],-e[1],e[2]];function Jl(e){return Math.hypot(...e)}function Yl(e){let t=Jl(e)||1;return e.map(e=>e/t)}function Xl(e,t){return[e[1]*t[2]-e[2]*t[1],e[2]*t[0]-e[0]*t[2],e[0]*t[1]-e[1]*t[0]]}function Zl(e,t,n){return[e[0],t[0],n[0],e[1],t[1],n[1],e[2],t[2],n[2]]}function Ql(e,t){let n=Array(9);for(let r=0;r<3;r++)for(let i=0;i<3;i++)n[r*3+i]=e[r*3]*t[i*3]+e[r*3+1]*t[i*3+1]+e[r*3+2]*t[i*3+2];return n}function $l(e,t){return[e[0]*t[0]+e[1]*t[1]+e[2]*t[2],e[3]*t[0]+e[4]*t[1]+e[5]*t[2],e[6]*t[0]+e[7]*t[1]+e[8]*t[2]]}function eu(e){let t=e[0]+e[4]+e[8],n=Math.min(1,Math.max(-1,(t-1)/2)),r=Math.acos(n);if(r<1e-9)return[0,0,0];let i=Math.sin(r);if(i<1e-6){let t=[e[0]+1,e[4]+1,e[8]+1],n=t.indexOf(Math.max(...t)),i=[e[n],e[3+n],e[6+n]];return i[n]+=1,Yl(i).map(e=>e*r)}return[(e[7]-e[5])/(2*i)*r,(e[2]-e[6])/(2*i)*r,(e[3]-e[1])/(2*i)*r]}function tu(e){let[t,n,r]=e[0],[i,a,o]=e[1],[s,c,l]=e[2],u=t*(a*l-o*c)-n*(i*l-o*s)+r*(i*c-a*s);if(Math.abs(u)<1e-14)return null;let d=1/u;return[[(a*l-o*c)*d,(r*c-n*l)*d,(n*o-r*a)*d],[(o*s-i*l)*d,(t*l-r*s)*d,(r*i-t*o)*d],[(i*c-a*s)*d,(n*s-t*c)*d,(t*a-n*i)*d]]}function nu(e,t,n){let r=tu([0,1,2].map(t=>[0,1,2].map(r=>e[t].reduce((t,n,i)=>t+n*e[r][i],0)+(t===r?n:0))));return r?Array.from({length:t},(t,n)=>[0,1,2].map(t=>e[0][n]*r[0][t]+e[1][n]*r[1][t]+e[2][n]*r[2][t])):null}function ru(e,t,n){return Array.from({length:n},(n,r)=>e[r][0]*t[0]+e[r][1]*t[1]+e[r][2]*t[2])}function iu(e,t,n,r={}){let{lambda:i=.08,maxStep:a=.12,iters:o=6,oriWeight:s=.1,tilt:c=.9}=r,l=(n,r)=>e.mj_name2id(t,n.value,r),u=Hl.map(t=>l(e.mjtObj.mjOBJ_JOINT,`${n}_${t}_Joint`)),d=Hl.map(t=>l(e.mjtObj.mjOBJ_ACTUATOR,`${n}_${t}_Position`)),f=l(e.mjtObj.mjOBJ_BODY,`${n}_Palm_Link`);if(u.includes(-1)||d.includes(-1)||f<0)throw Error(`IK: could not resolve ${n} arm in the model`);let p=u.map(e=>t.jnt_qposadr[e]),m=u.map(e=>t.jnt_dofadr[e]),h=u.map(e=>t.jnt_range[e*2]),g=u.map(e=>t.jnt_range[e*2+1]),_=ql(Wl,n),v=Yl(ql(Gl,n)),y=Yl(ql(Kl,n)),b=Zl(v,y,Yl(Xl(v,y))),x=new e.MjData(t),S=new e.DoubleBuffer(3*t.nv),C=new e.DoubleBuffer(3*t.nv),w=S.GetView(),T=C.GetView(),E=p.map(e=>x.qpos[e]);function D(){let e=[x.xpos[f*3],x.xpos[f*3+1],x.xpos[f*3+2]],t=Array.from({length:9},(e,t)=>x.xmat[f*9+t]);return{R:t,point:e.map((e,n)=>e+$l(t,_)[n])}}function O(n,r=0){let l=Yl([-Math.sin(c)*Math.cos(r),-Math.sin(c)*Math.sin(r),-Math.cos(c)]),u=[Math.cos(r),Math.sin(r),0];u=Yl(Xl(u,l)),u=Yl(Xl(l,u));let d=Ql(Zl(u,l,Yl(Xl(u,l))),b),_=0,v=0;for(let r=0;r<o;r++){for(let e=0;e<Ul;e++)x.qpos[p[e]]=E[e];e.mj_kinematics(t,x),e.mj_comPos(t,x);let{R:r,point:o}=D(),c=[n[0]-o[0],n[1]-o[1],n[2]-o[2]],l=eu(Ql(d,r));if(_=Jl(c),v=Jl(l),_<5e-4&&v<.005)break;e.mj_jac(t,x,S,C,o,f);let u=[0,1,2].map(e=>m.map(n=>w[e*t.nv+n])),y=[0,1,2].map(e=>m.map(n=>T[e*t.nv+n])),b=i*i,O=nu(u,Ul,b);if(!O)break;let ee=ru(O,c,Ul),k=nu(y,Ul,b);if(k){let e=ru(k,l,Ul);for(let t=0;t<Ul;t++){let n=e[t];for(let r=0;r<Ul;r++){let i=O[t][0]*u[0][r]+O[t][1]*u[1][r]+O[t][2]*u[2][r];n-=i*e[r]}ee[t]+=n*s}}let te=Jl(ee),A=te>a?a/te:1;for(let e=0;e<Ul;e++)E[e]=Math.min(g[e],Math.max(h[e],E[e]+ee[e]*A))}return{posErr:_,oriErr:v}}function ee(e){for(let t=0;t<Ul;t++)e.ctrl[d[t]]=E[t]}function k(){for(let e=0;e<Ul;e++)x.qpos[p[e]]=E[e];return e.mj_kinematics(t,x),D().point}return{solve:O,apply:ee,graspPoint:k,jointCount:Ul,side:n}}var au={forward:[`w`,`W`],back:[`s`,`S`],left:[`a`,`A`],right:[`d`,`D`],up:[`r`,`R`],down:[`f`,`F`],yawCcw:[`q`,`Q`],yawCw:[`e`,`E`],grip:[` `],switchHand:[`Tab`],reset:[`g`,`G`],home:[`h`,`H`],view:[`v`,`V`]},ou=[[`W / S`,`forward / back`,`Moves the grasp target away from / toward the robot along its facing axis.`],[`A / D`,`left / right`,`Slides the grasp target sideways, from the robot's point of view.`],[`R / F`,`up / down`,`Raises or lowers the grasp target. Bench top sits at 0.15 m.`],[`Q / E`,`rotate grip`,`Spins the closing axis about vertical, to line the fingers up with an object.`],[`Space`,`close hand (hold)`,`Ramps the grip while held. One axis drives every finger; the 4th-order polynomial coupling then drives the distal joints.`],[`Shift`,`precision`,`Quarter speed on every axis, for placing the hand rather than swinging it.`],[`Tab`,`switch hand`,`Hands over control to the other arm. The idle arm holds its last pose.`],[`V`,`first ⇄ third person`,`Toggles between the robot's own head camera and a free orbit camera.`],[`H`,`recentre target`,`Snaps the grasp target back to its starting point over the bench.`],[`G`,`reset scene`,`Returns the robot and every prop to the starting state.`],[`Esc`,`menu`,`Opens status and settings. Press again to return to the scene.`],[`drag`,`orbit camera`,`Third person only — the first-person view is fixed to the head.`],[`wheel`,`zoom`,`Third person only.`]],su={x:.45,y:.15,z:.34};function cu(e,t,n={}){let{moveRate:r=.3,yawRate:i=2,gripRate:a=3.2,precision:o=.25,bounds:s={x:[.1,.7],y:[-.45,.45],z:[.02,.95]}}=n,c={target:new G(su.x,su.y,n.height??su.z),yaw:0,grip:0,hand:`L`,view:`fpv`,resetRequested:!1,gamepadGrip:!1},l=new Set,u=new Set([` `,`Tab`]);addEventListener(`keydown`,e=>{u.has(e.key)&&e.preventDefault(),l.has(e.key)||(au.switchHand.includes(e.key)&&(c.hand=c.hand===`L`?`R`:`L`),au.reset.includes(e.key)&&(c.resetRequested=!0),au.home.includes(e.key)&&c.target.set(su.x,su.y,su.z),au.view.includes(e.key)&&(c.view=c.view===`fpv`?`orbit`:`fpv`)),l.add(e.key)}),addEventListener(`keyup`,e=>l.delete(e.key)),addEventListener(`blur`,()=>l.clear());let d=e=>e.some(e=>l.has(e)),f=(e,[t,n])=>Math.min(n,Math.max(t,e));function p(e){let t=l.has(`Shift`)?o:1,n=r*e*t;d(au.forward)&&(c.target.x+=n),d(au.back)&&(c.target.x-=n),d(au.left)&&(c.target.y+=n),d(au.right)&&(c.target.y-=n),d(au.up)&&(c.target.z+=n),d(au.down)&&(c.target.z-=n),c.target.x=f(c.target.x,s.x),c.target.y=f(c.target.y,s.y),c.target.z=f(c.target.z,s.z),d(au.yawCcw)&&(c.yaw+=i*e*t),d(au.yawCw)&&(c.yaw-=i*e*t);let u=navigator.getGamepads?.().find(e=>e&&e.connected),p=u?Math.max(u.buttons[6]?.value??0,u.buttons[7]?.value??0):0;if(c.gamepadGrip=p>.02,c.gamepadGrip)c.grip=p;else{let t=+!!d(au.grip);c.grip+=Math.sign(t-c.grip)*Math.min(Math.abs(t-c.grip),a*e)}let m=c.resetRequested;return c.resetRequested=!1,{target:[c.target.x,c.target.y,c.target.z],yaw:c.yaw,grip:c.grip,hand:c.hand,view:c.view,reset:m,fine:t!==1,gamepad:c.gamepadGrip,moving:d(au.forward)||d(au.back)||d(au.left)||d(au.right)||d(au.up)||d(au.down)}}return{update:p,state:c}}var lu=new URLSearchParams(location.search).get(`mjcf`)??`mjcf/game_level0_slim.xml`,uu=[`Index`,`Middle`,`Ring`,`Little`],du={MCP:1.35,PIP:1.55},fu={CMC:1.15,MCP:1.25,OPPOSE:1.45},pu=new Map,mu=document.getElementById(`log`),hu=document.getElementById(`stats`),gu=performance.now(),_u=[];function vu(e,t){_u.push([e,performance.now()-t])}function yu(e){console.log(`[probe]`,e),mu.textContent=e;let t=document.getElementById(`boot`);t&&!t.hidden&&(t.textContent=e)}function bu(e,t,n=``){pu.set(e,{v:t,cls:n}),hu.innerHTML=[...pu].map(([e,t])=>`<tr><td class="k">${e}</td><td class="v ${t.cls}">${t.v}</td></tr>`).join(``)}var xu=e=>new URL(e,document.baseURI).href;async function Su(e,t){let n=xu(`model/${t}`),r=await fetch(n);if(!r.ok)throw Error(`fetch ${n} -> ${r.status}`);let i=new Uint8Array(await r.arrayBuffer()),a=`/model/`+t.split(`/`).slice(0,-1).join(`/`);return e.FS.mkdirTree(a),e.FS.writeFile(`/model/${t}`,i),i.byteLength}async function Cu(e,t){let n=performance.now(),r=new TextDecoder,i=0,a=new Set,o=new Set,s=[t];for(;s.length;){let t=s.pop();if(a.has(t))continue;a.add(t),i+=await Su(e,t);let n=r.decode(e.FS.readFile(`/model/${t}`)),c=t.split(`/`).slice(0,-1).join(`/`);for(let e of n.matchAll(/<include\s+file="([^"]+)"/gi))s.push(c?`${c}/${e[1]}`:e[1]);for(let e of n.matchAll(/file="([^"]+\.stl)"/gi))o.add(e[1])}let c=[...o];bu(`xml staged`,a.size),bu(`meshes referenced`,c.length),yu(`staging ${c.length} meshes…`);let l=0,u=await Promise.all(Array.from({length:12},async()=>{let t=0;for(;c.length;){let n=c.pop();t+=await Su(e,`meshes/${n}`),++l%20==0&&yu(`staging meshes… ${l}`)}return t}));i+=u.reduce((e,t)=>e+t,0);let d=performance.now()-n;return bu(`staged`,`${(i/1048576).toFixed(1)} MB`),bu(`stage time`,`${(d/1e3).toFixed(2)} s`),i}var wu={PLANE:0,SPHERE:2,CAPSULE:3,ELLIPSOID:4,CYLINDER:5,BOX:6,MESH:7};function Tu(e,t){let n=e.mesh_vertadr[t],r=e.mesh_vertnum[t],i=e.mesh_faceadr[t],a=e.mesh_facenum[t],o=new Float32Array(r*3);for(let t=0;t<r*3;t++)o[t]=e.mesh_vert[n*3+t];let s=new Uint32Array(a*3);for(let t=0;t<a*3;t++)s[t]=e.mesh_face[i*3+t];let c=new zr;return c.setAttribute(`position`,new wr(o,3)),c.setIndex(new wr(s,1)),c.computeVertexNormals(),c}function Eu(e,t){switch(e){case wu.PLANE:return new Ai(20,20);case wu.SPHERE:return new ji(t[0],24,16);case wu.CYLINDER:return new ki(t[0],t[0],t[1]*2,24);case wu.CAPSULE:return new Oi(t[0],t[1]*2,8,16);case wu.ELLIPSOID:return new ji(1,24,16).scale(t[0],t[1],t[2]);case wu.BOX:return new Di(t[0]*2,t[1]*2,t[2]*2);default:return null}}function Du(e,t){let n=new In;n.rotation.x=-Math.PI/2;let r=0;for(let e=0;e<t.ngeom;e++)t.geom_group[e]<3&&r++;let i=r===0;bu(`render source`,i?`collision geoms`:`visual geoms`,i?`warn`:``);let a=[],o=0;for(let e=0;e<t.ngeom;e++){if(!i&&t.geom_group[e]>=3){o++;continue}let r=t.geom_type[e],s=[t.geom_size[e*3],t.geom_size[e*3+1],t.geom_size[e*3+2]],c=r===wu.MESH?Tu(t,t.geom_dataid[e]):Eu(r,s);if(!c)continue;let l=t.geom_matid[e],u=l>=0?[0,1,2,3].map(e=>t.mat_rgba[l*4+e]):[0,1,2,3].map(n=>t.geom_rgba[e*4+n]),d=new di(c,new Ui({color:new X(u[0],u[1],u[2]),metalness:.08,roughness:.62,transparent:u[3]<1,opacity:u[3]}));d.userData.localPos=new G(t.geom_pos[e*3],t.geom_pos[e*3+1],t.geom_pos[e*3+2]),d.userData.localQuat=new Vt(t.geom_quat[e*4+1],t.geom_quat[e*4+2],t.geom_quat[e*4+3],t.geom_quat[e*4]),d.userData.bodyId=t.geom_bodyid[e],n.add(d),a.push(d)}return bu(`rendered geoms`,a.length),bu(`collision hidden`,o),{root:n,visuals:a}}async function Ou(e,t,n,r){let i;try{i=await fetch(xu(`render/scene.json`)).then(e=>e.ok?e.json():Promise.reject(e.status))}catch{bu(`render assets`,`missing — run export_render_assets.py`,`bad`);return}let a=new Bl;a.setDecoderPath(xu(`draco/`)),a.setDecoderConfig({type:`wasm`});let o=e=>new Promise((t,n)=>{a.load(xu(`render/${e.file}`),t,void 0,n)}),s=0,c=Array(i.meshes.length),l=i.meshes.map((e,t)=>[e,t]);await Promise.all(Array.from({length:8},async()=>{for(;l.length;){let[e,t]=l.pop();try{let n=await o(e);n.computeVertexNormals(),c[t]=n}catch(t){console.error(`[probe] draco failed:`,e.file,t)}++s%15==0&&yu(`decoding meshes… ${s}/${i.meshes.length}`)}})),a.dispose();let u=c.filter(Boolean).length;u<i.meshes.length&&bu(`draco decode`,`${u}/${i.meshes.length} ok`,`bad`);let d=new Map,f=0;for(let a of i.geoms){if(!c[a.mesh])continue;let i=e.mj_name2id(t,e.mjtObj.mjOBJ_BODY.value,a.body);if(i<0){f++;continue}let o=a.rgba.join(`,`);d.has(o)||d.set(o,new Ui({color:new X(a.rgba[0],a.rgba[1],a.rgba[2]),metalness:.1,roughness:.55,transparent:a.rgba[3]<1,opacity:a.rgba[3]}));let s=new di(c[a.mesh],d.get(o));s.userData.localPos=new G(...a.pos),s.userData.localQuat=new Vt(a.quat[1],a.quat[2],a.quat[3],a.quat[0]),s.userData.bodyId=i,n.add(s),r.push(s)}let p=i.meshes.reduce((e,t)=>e+(t.verts||0),0);bu(`render assets`,`${i.geoms.length} geoms · ${p.toLocaleString()} verts`,`good`),bu(`mesh format`,`draco q${i.quantization}`+(i.reduction?` · reduced ${i.reduction}`:` · full res`),`good`),f&&bu(`unresolved bodies`,f,`bad`)}function ku(e,t){let n=new G,r=new Vt;for(let i of e){let e=i.userData.bodyId;n.set(t.xpos[e*3],t.xpos[e*3+1],t.xpos[e*3+2]),r.set(t.xquat[e*4+1],t.xquat[e*4+2],t.xquat[e*4+3],t.xquat[e*4]),i.position.copy(i.userData.localPos).applyQuaternion(r).add(n),i.quaternion.copy(r).multiply(i.userData.localQuat)}}function Au(e,t){let n=new Map;for(let r=0;r<t.nu;r++){let i=e.mj_id2name(t,e.mjtObj.mjOBJ_ACTUATOR.value,r);i&&n.set(i,r)}return n}var ju=30*Math.PI/180;function Mu(e,t){let n=t.get(`Neck_Pitch_Position`);n!==void 0&&(e.ctrl[n]=ju)}function Nu(e,t,n,r){let i=(n,r)=>{let i=t.get(n);i!==void 0&&(e.ctrl[i]=r)};for(let e of uu)i(`${r}_${e}_MCP_Position`,n*du.MCP),i(`${r}_${e}_PIP_Position`,n*du.PIP);i(`${r}_Thumb_CMC_Position`,n*fu.CMC),i(`${r}_Thumb_MCP_Position`,n*fu.MCP),i(`${r}_Thumb_Yaw_Position`,r===`L`?fu.OPPOSE:-fu.OPPOSE)}async function Pu(){yu(`loading physics engine…`);let e=performance.now(),t=await p();vu(`wasm`,e),bu(`mujoco`,t.mj_versionString?t.mj_versionString():`loaded`,`good`),bu(`scene`,lu),e=performance.now(),await Cu(t,lu),vu(`fetch model`,e),yu(`compiling model…`);let n=performance.now(),r=t.MjModel.from_xml_path(`/model/${lu}`),i=new t.MjData(r),a=performance.now()-n;vu(`compile`,n);let o=r.opt.timestep;bu(`compile time`,`${(a/1e3).toFixed(2)} s`,a>5e3?`warn`:`good`),bu(`nq / nv / nu`,`${r.nq} / ${r.nv} / ${r.nu}`),bu(`ngeom / neq`,`${r.ngeom} / ${r.neq}`),bu(`model timestep`,`${o.toFixed(5)} s`);let s=Au(t,r);function c(e,n,a){t.mj_resetData(r,i),Nu(i,s,n,`L`),Nu(i,s,n,`R`);for(let e=0;e<600;e++)t.mj_step(r,i);let c=2e3,l=performance.now();for(let e=0;e<c;e++)t.mj_step(r,i);let u=c/(performance.now()-l)*1e3,d=u*o;return bu(e,`${u.toFixed(0)} st/s · ${d.toFixed(2)}x · ncon ${i.ncon}`,a??(d>=2?`good`:d>=1?`warn`:`bad`)),d}if(new URLSearchParams(location.search).has(`bench`)){yu(`benchmarking physics…`),e=performance.now(),c(`bench: hands open`,0);let n=c(`bench: hands closed`,1);bu(`budget @60fps`,`${(100/n).toFixed(1)}% of frame`,n>=2?`good`:`warn`),vu(`benchmark`,e),t.mj_resetData(r,i)}let l=document.getElementById(`view`),u=new fl({canvas:l,antialias:!0});u.setPixelRatio(Math.min(devicePixelRatio,2));let d=new Gn;d.background=new X(1316636),d.fog=new Wn(1316636,4,14);let f=new Ta(45,1,.02,100);f.position.set(1.5,.95,1.15);let h=new Cl(f,u.domElement);h.target.set(.35,.3,0),h.enableDamping=!0,h.mouseButtons={LEFT:m.ROTATE,MIDDLE:m.DOLLY,RIGHT:m.ROTATE},u.domElement.addEventListener(`contextmenu`,e=>e.preventDefault()),d.add(new pa(12374766,1777446,1));let g=new Oa(16777215,2);g.position.set(2.4,3.2,1.8),d.add(g);let _=new Oa(9680096,.5);_.position.set(-2,1.5,-1.6),d.add(_),t.mj_resetData(r,i),t.mj_forward(r,i);let{root:v,visuals:y}=Du(t,r);e=performance.now(),await Ou(t,r,v,y),vu(`render assets`,e),bu(`rendered total`,y.length),d.add(v);let b=Au(t,r);bu(`actuators mapped`,b.size,b.size===r.nu?`good`:`warn`);let x={L:iu(t,r,`L`),R:iu(t,r,`R`)},S=cu(l,f,{height:.32}),C=e=>`<span class="key">${e}</span>`;document.getElementById(`keys`).innerHTML=ou.map(([e,t])=>`<tr><td>${C(e)}</td><td>${t}</td></tr>`).join(``),document.getElementById(`keydetail`).innerHTML=ou.map(([e,t,n])=>`<tr><td>${C(e)}</td><td>${t}<div class="why">${n}</div></td></tr>`).join(``);let w=document.getElementById(`menu`),T=document.getElementById(`tab-status`),E=document.getElementById(`tab-keys`),D=document.getElementById(`pane-status`),O=document.getElementById(`pane-keys`);function ee(e){let t=e===`status`;T.setAttribute(`aria-selected`,String(t)),E.setAttribute(`aria-selected`,String(!t)),D.hidden=!t,O.hidden=t}T.addEventListener(`click`,()=>ee(`status`)),E.addEventListener(`click`,()=>ee(`keys`)),addEventListener(`keydown`,e=>{e.key===`Escape`&&(e.preventDefault(),w.hidden=!w.hidden,w.hidden||dispatchEvent(new Event(`blur`)))});let k=document.getElementById(`gripfill`),te=document.getElementById(`gripval`),A=new In,ne=new di(new Mi(.035,.0035,8,40),new $r({color:7200655,transparent:!0,opacity:.9}));ne.rotation.x=Math.PI/2;let re=new di(new ki(.0015,.0015,1,6),new $r({color:7200655,transparent:!0,opacity:.35}));A.add(ne,re),d.add(A);let ie=new di(new ji(.012,16,12),new $r({color:15778408}));d.add(ie);let ae=([e,t,n])=>new G(e,n,-t),oe=t.mj_name2id(r,t.mjtObj.mjOBJ_BODY.value,`orbbec_link`);oe<0&&bu(`fpv`,`orbbec_link missing`,`bad`);let se=[1,0,0],ce=[0,0,1],le=e=>{let t=Bt.degToRad(e);se=[Math.cos(t),0,-Math.sin(t)],ce=[Math.sin(t),0,Math.cos(t)]},j=new G,ue=new G,de=new G,fe=(e,t)=>[e[0]*t[0]+e[1]*t[1]+e[2]*t[2],e[3]*t[0]+e[4]*t[1]+e[5]*t[2],e[6]*t[0]+e[7]*t[1]+e[8]*t[2]];function pe(){if(oe<0)return!1;let e=[i.xpos[oe*3],i.xpos[oe*3+1],i.xpos[oe*3+2]],t=Array.from({length:9},(e,t)=>i.xmat[oe*9+t]);return j.copy(ae(e)),ue.copy(ae(fe(t,se))).add(j),de.copy(ae(fe(t,ce))),f.position.copy(j),f.up.copy(de),f.lookAt(ue),!0}let M=document.getElementById(`fov`),N=document.getElementById(`fovval`),me=()=>{f.fov=Number(M.value),f.updateProjectionMatrix(),N.textContent=`${M.value}°`};M.addEventListener(`input`,me),me();let he=document.getElementById(`pitch`),ge=document.getElementById(`pitchval`),_e=()=>{le(Number(he.value)),ge.textContent=`${he.value}°`};he.addEventListener(`input`,_e),_e();let ve={pos:f.position.clone(),target:h.target.clone()},ye=null;window.__probe={mujoco:t,model:r,data:i,ik:x,input:S,acts:b};function be(){let e=l.clientWidth||innerWidth,t=l.clientHeight||innerHeight;!e||!t||(u.setSize(e,t,!1),f.aspect=e/t,f.updateProjectionMatrix())}new ResizeObserver(be).observe(l),addEventListener(`resize`,be),be();let xe=0,Se=performance.now(),Ce=0,we=Se,Te=0,Ee=performance.now()-gu;bu(`startup`,`${(Ee/1e3).toFixed(2)} s total`,Ee<5e3?`good`:Ee<9e3?`warn`:`bad`);for(let[e,t]of _u)bu(`  ${e}`,`${(t/1e3).toFixed(2)} s`);console.log(`[probe] startup breakdown`,_u.map(([e,t])=>`${e} ${(t/1e3).toFixed(2)}s`).join(` · `),`| total ${(Ee/1e3).toFixed(2)}s`),document.getElementById(`boot`).hidden=!0,yu(`running.`),u.setAnimationLoop(()=>{let e=performance.now(),n=(e-Se)/1e3;Se=e,n>.25&&(n=.25);let a=S.update(n);a.reset&&(t.mj_resetData(r,i),t.mj_forward(r,i)),Mu(i,b);let s=x[a.hand],c=s.solve(a.target,a.yaw);s.apply(i),x[a.hand===`L`?`R`:`L`].apply(i),Nu(i,b,a.grip,a.hand),k.style.width=`${(a.grip*100).toFixed(0)}%`,te.textContent=a.grip.toFixed(2),A.position.copy(ae(a.target));let l=Math.max(.001,a.target[2]-.15);re.scale.y=l,re.position.y=-l/2,ie.position.copy(ae(s.graspPoint())),xe+=n;let p=0;for(;xe>=o&&p<40;)t.mj_step(r,i),xe-=o,p++;if(p===40&&(xe=0),Te+=p,ku(y,i),a.view!==ye&&(a.view===`fpv`?(ve.pos.copy(f.position),ve.target.copy(h.target)):(f.position.copy(ve.pos),f.up.set(0,1,0),h.target.copy(ve.target)),h.enabled=a.view===`orbit`,ye=a.view),a.view===`fpv`?pe():h.update(),u.render(d,f),Ce++,e-we>500){let t=(e-we)/1e3;bu(`fps`,(Ce/t).toFixed(0)),bu(`substeps/frame`,(Te/Ce).toFixed(1)),bu(`contacts`,i.ncon),bu(`view`,a.view===`fpv`?`first person · Femto Bolt −30°`:`third person · orbit`),bu(`hand`,a.hand+(a.fine?` (fine)`:``)+(a.gamepad?` · pad grip`:``)),bu(`target xyz`,a.target.map(e=>e.toFixed(2)).join(`  `)),bu(`grip yaw`,`${(a.yaw*57.2958).toFixed(0)}°`),bu(`IK residual`,`${(c.posErr*1e3).toFixed(1)} mm · ${(c.oriErr*57.2958).toFixed(1)}°`,c.posErr<.01?`good`:c.posErr<.05?`warn`:`bad`),Ce=0,Te=0,we=e}})}`serviceWorker`in navigator&&addEventListener(`load`,()=>{navigator.serviceWorker.register(xu(`sw.js`)).catch(e=>console.warn(`[probe] service worker registration failed`,e))}),Pu().catch(e=>{console.error(e),yu(`FAILED: `+(e?.message??e)),bu(`status`,`failed`,`bad`)});export{o as t};